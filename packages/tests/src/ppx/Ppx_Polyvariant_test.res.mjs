...
let polyEmbededSchema = S$RescriptSchema.to(S$RescriptSchema.string, param => "one");

Ava("Embed custom schema for polymorphic variants", t => U.assertEqualSchemas(t, polyEmbededSchema, S$RescriptSchema.to(S$RescriptSchema.string, param => "one"), undefined));
